...
* `RezEvent.modalCard("card_id", params)` - Show a modal to the player by rendering the card into the modal. The card can define a `title:` attribute for the modal title.
