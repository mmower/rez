...
The Rez Cookbook is an library of optional functionality that you can incorporate into
your own Rez games. For example a way of representing dynamic actions or maps & locations.

It is hosted via a Github https://github.com/mmower/rez-cookbook[repository] and available
using a simple `rez cookbook` commands from the command-line.
