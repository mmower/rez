defmodule Rez.Compiler.Phases.ResolveConstants do
  ...
  def run_phase(%Compilation{status: :ok, content: content, constants: constants, progress: progress} = compilation) do
  ...
  defp resolve_constants_in_attribute(%Attribute{type: :const_ref, value: const_name} = attr, constants) do
